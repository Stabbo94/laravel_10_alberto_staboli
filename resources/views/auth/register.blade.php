        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 my-0 py-5 text-center">
                    <h1 class="text-center my-0">Registrati al nostro Shop!</h1>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <form method="POST" action="{{route('register')}}">
                    ...
                    <button type="submit" class="btn btn-light w-100 mt-4 d-flex align-items-center justify-content-center">Registrati</button>
                </form>
            </div>
        </div>
    </div>
